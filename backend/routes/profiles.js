...
const validateProfile = (data) => {
  ...
  if (data.experienceYears && data.experienceYears < 0) errors.push('Experience cannot be negative');
  if (data.hourlyRate && data.hourlyRate < 0) errors.push('Hourly rate cannot be negative');
